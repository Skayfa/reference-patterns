...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/Skayfa/reference-patterns/fullstack/auth/paseto-cross-language/issuer-go/pb/note/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	NoteServiceDeleteNoteProcedure = "/note.v1.NoteService/DeleteNote"
)
...
// DeleteNote calls note.v1.NoteService.DeleteNote.
...
func (UnimplementedNoteServiceHandler) DeleteNote(context.Context, *connect.Request[v1.DeleteNoteRequest]) (*connect.Response[v1.DeleteNoteResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("note.v1.NoteService.DeleteNote is not implemented"))
}
